...
class TestCaseRequestWithSkipStep(HttpRunner):
    ...
    teststeps = [
        ...
        Step(
            RunRequest("skip this step with skip_if and condition was boolean True")
            .skip_if(True, "reason 2021")
            .post("/post")
            .with_headers(
                **{
        ...
        Step(
            RunRequest("run this step with skip_if and condition was boolean False")
            .skip_if(False, "reason 2021")
            .post("/post")
            .with_headers(
                **{
        ...
        Step(
            RunRequest("run this step with skip_unless and condition was boolean True")
            .skip_unless(True, "reason 2021")
            .post("/post")
            .with_headers(
                **{
        ...
        Step(
            RunRequest(
                "skip this step with skip_unless and condition was boolean False"
            )
            .skip_unless(False, "reason 2021")
            .post("/post")
            .with_headers(
